OpenStreetMap::Application.routes.draw do
  ...
  # Map Notes API  
  match "api/#{API_VERSION}/notes/getNotes" =>'note#list'
  match "api/#{API_VERSION}/notes/addPOIexec" => 'note#create'
  match "api/#{API_VERSION}/notes/closePOIexec" =>'note#close'
  match "api/#{API_VERSION}/notes/editPOIexec" =>'note#update'
  match "api/#{API_VERSION}/notes/getGPX" =>'note#gpx_notes'
  match "api/#{API_VERSION}/notes/getRSSfeed" =>'note#rss'

  match "api/#{API_VERSION}/notes" => 'note#list'
  match "api/#{API_VERSION}/notes/search" => 'note#search'
  match "api/#{API_VERSION}/notes/rss" =>'note#rss'
  match "api/#{API_VERSION}/note/create"  => 'note#create'
  match "api/#{API_VERSION}/note/:id/comment" => 'note#update', :id => /\d+/
  match "api/#{API_VERSION}/note/:id/close" => 'note#close', :id => /\d+/
  match "api/#{API_VERSION}/note/:id" => 'note#read', :id => /\d+/, :conditions => { :method => :get }
  match "api/#{API_VERSION}/note/:id" => 'note#delete', :id => /\d+/, :conditions => { :method => :delete }
